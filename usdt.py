...
if __name__ == '__main__':
    ...
    p1 = mp.Process(target=mainProg, args=(api_key1, 1,3954,))
    p2 = mp.Process(target=mainProg, args=(api_key2, 2,3955,))
    p3 = mp.Process(target=mainProg, args=(api_key3, 3,3956,))
    """
