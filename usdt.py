...
if __name__ == '__main__':
    ...
    p1 = mp.Process(target=mainProg, args=(api_key1, 1,3957,))
    p2 = mp.Process(target=mainProg, args=(api_key2, 2,3958,))
    p3 = mp.Process(target=mainProg, args=(api_key3, 3,3959,))
    """
